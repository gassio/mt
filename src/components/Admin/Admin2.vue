    ...
    <div class="admin container">
		<div class="columns">
			...
			<div class="admin__main column is-10">
				...
				<div class="admin__head">
					<div class= "columns is-mobile is-gapless is-marginless">
						<div class="column is-4">
							<div class="admin__genre ui dropdown selection">
								<input type="hidden" name="gender">
								<div class="text">Lab presentation</div><i class="dropdown icon"></i>
								<div class="menu">
									<div class="item" v-for="genre in genres" :key="genre.name">{{ genre.name }}</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="ui cards"> <!--admin__featured -->

					<a class="ui card" href="http://www.google.com">
						<div class="image">
							<img src="https://cdn.jwplayer.com/thumbs/PWGQS5HM-720.jpg">
						</div>
						<div class="content">
							<div class="ui small header">Mechanical Properties Of Crystals And Glasses - Group 5</div>
							<div class="meta">
								<span class="date">Materials Science and Engineering</span>
							</div>
							<div class="description">2017-10-16</div>
						</div>
						<div class="extra content">
							<a><i class="commenting icon"></i>Lab presentation</a>
						</div>
					</a>
					...
					<a class="ui card" href="http://www.google.com">
						...
						<div class="content">
							<a class="ui small header">Mechanical Properties Of Crystals And Glasses - Group 5</a>
							<div class="meta">
								<span class="date">Materials Science and Engineering</span>
							</div>
							<div class="description">2017-10-16</div>
